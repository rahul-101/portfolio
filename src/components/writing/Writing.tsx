...
export default function Writing({ delay = 0 }: { delay?: number }) {
  return (
    <Section id="writing" label="07 — Writing" title="Notes from the Trenches of AI & Automation." delay={delay}>
      <div className="grid gap-5 sm:grid-cols-2">
        {writing.map((w, i) => (
          <SpotlightCard key={w.title}>
            <ScrollReveal delay={delay + i * 0.05}>
